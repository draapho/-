...
本卦「{{name}}」{% if bian.name %}　变卦「{{bian.name}}」{% endif %}
互卦「{{hu.name}}」　错卦「{{cuo.name}}」　综卦「{{zong.name}}」

{{main_bian_titles_line}}
...
{# 互卦, 错卦, 综卦详细信息.
{{aux_titles_line}}
{{hu.mark.5}}{{gap_hu_cuo}}{{cuo.mark.5}}{{gap_cuo_zong}}{{zong.mark.5}}
{{hu.mark.4}}{{gap_hu_cuo}}{{cuo.mark.4}}{{gap_cuo_zong}}{{zong.mark.4}}
{{hu.mark.3}}{{gap_hu_cuo}}{{cuo.mark.3}}{{gap_cuo_zong}}{{zong.mark.3}}
{{hu.mark.2}}{{gap_hu_cuo}}{{cuo.mark.2}}{{gap_cuo_zong}}{{zong.mark.2}}
{{hu.mark.1}}{{gap_hu_cuo}}{{cuo.mark.1}}{{gap_cuo_zong}}{{zong.mark.1}}
{{hu.mark.0}}{{gap_hu_cuo}}{{cuo.mark.0}}{{gap_cuo_zong}}{{zong.mark.0}}
#}
